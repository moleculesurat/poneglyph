/* Bulk-decide drafts at the human gate.
   usage: node scripts/decide.mjs approve|reject OBL-003,OBL-004,… [--base URL]
...
if (decision !== "approve" && decision !== "reject") fail('usage: decide.mjs approve|reject <id,id,…> [--base URL]');
